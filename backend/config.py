...
class Settings(BaseSettings):
    ...
    benchmark_repetition: int = 1
    benchmark_expected_flag_sha256: str = ""
    ...
    writeup_idle_timeout_seconds: int = 600
    # Keep documentation generation independent from the primary solver budget.
    ...
    max_interactive_sessions: int = 4
    interactive_session_ttl_seconds: int = 900
